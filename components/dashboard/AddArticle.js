...
function AddArticle(props) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("/api/articles/addarticle", {
        method: "POST",
        headers: {
      ...
      if (data.message === "Success") {
        setError("");
        toast.success("Article posted, Redirecting...", {
          position: "top-right",
          autoClose: 1500,
          ...
          <div className="w-[100%]">
            ...
            <div className="flex flex-col items-center">
              ...
              <div>
                <button
                  className={`w-40 ${
                    authInProcess ? "bg-blue-400" : "bg-blue-800"
                  } opacity-90 hover:opacity-100 duration-300 font-semibold hover:tracking-wide text-white p-2 rounded-sm cursor-pointer m-8`}
